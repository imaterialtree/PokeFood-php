<nav class="navbar navbar-expand-lg bg-body-tertiary justify-content-center">
    <div class="container-fluid text-center">
        <a class="navbar-brand" href="#">PokeFood</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav justify-content-center m-auto ">
                <li class="nav-item"><a href="?secao=cadComida" class="nav-link active">CADASTRO COMIDA</a></li>
                <li class="nav-item"><a href="?secao=manageComida" class="nav-link">GERENCIAR CARDAPIO</a></li>
